...
class MultiMap<K, V> {
	...
	/**
	 * Returns the Collection of values to which the specified key is mapped, or null if this multimap contains no
	 * mapping for the key.
	 */
	...
	/**
	 * Removes the mapping for the specified key from this multimap if present and returns the Collection of previous
	 * values associated with key, or null if there was no mapping for key.
	 */
	...
	/**
	 * Removes the entry for the specified key only if it is currently mapped to the specified value and return true if
	 * removed
	 */
	...
	/**
	 * Replaces the entry for the specified key only if currently mapped to the specified value and return true if
	 * replaced
	 */
