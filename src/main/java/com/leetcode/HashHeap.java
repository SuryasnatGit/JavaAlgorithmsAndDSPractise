...
/**
 * Definition: An efficient implementation of a priority queue. The linear hash function monotonically maps keys to
 * buckets, and each bucket is a heap. See also bucket sort. Note: This is a bucket sort where the buckets are organized
 * as heaps. The linear hash function maps increasing keys into nondecreasing values, that is, key1 > key2 implies
 * h(key1) is greater than or equal to h(key2). It is not clear what happens if a bucket gets full.
 * 
