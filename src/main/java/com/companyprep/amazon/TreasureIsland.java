 ...
 * time. The treasure island is marked as ‘X’ in a block of the matrix. ‘X’ will not be at the
 * top-left corner. Any block with dangerous rocks or reefs will be marked as ‘D’. You must not
 * enter dangerous blocks. You cannot leave the map area. Other areas ‘O’ are safe to sail in. The
 * top-left corner is always safe. Output the minimum number of steps to get to the treasure. from
 * aonecode.com
 * 
 * e.g. Input [ [‘O’, ‘O’, ‘O’, ‘O’], [‘D’, ‘O’, ‘D’, ‘O’], [‘O’, ‘O’, ‘O’, ‘O’], [‘X’, ‘D’, ‘D’,
 * ‘O’], ]
 * 
 * Output from aonecode.com Route is (0, 0), (0, 1), (1, 1), (2, 1), (2, 0), (3, 0) The minimum
 * route takes 5 steps.
 *
 */
