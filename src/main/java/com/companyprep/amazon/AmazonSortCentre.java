 ...
 * type of truck, they have different space units. For each package, they will be occupying
 * different space units. As a software development engineer in sort centers, you will need to write
 * a method:
 * 
 * Given truck space units and a list of product space units, find out exactly TWO products that fit
 * into the truck. You will also implement an internal rule that the truck has to reserve exactly 30
 * space units for safety purposes. Each package is assigned a unique ID, numbered from 0 to N-1.
 * 
 ...
 * Output :[2, 3]
 * 
 * Explanation : Given a truck of 90 space units, a list of packages space units [1, 10, 25, 35,
 * 60], Your method should select the third(ID-2) and fourth(ID-3) package since you have to reserve
 * exactly 30 space units.
 * 
 * 
 * @author M_402201
 *
