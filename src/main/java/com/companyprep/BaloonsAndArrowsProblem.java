 ...
 * 
 * explanation: using first arrow shoot: 5 4 3 2 1 using second arrow shoot: 3 2 1 using third arrow shoot: 1
 * 
 * Example 2: 5 4 2 1
 * 
 * minimum number of arrows to shoot them is: 2 using first arrow shoot: 5 4 using second arrow shoot: 2 1
 * 
