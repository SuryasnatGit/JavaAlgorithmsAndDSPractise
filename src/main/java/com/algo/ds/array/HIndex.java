 ...
 * function to compute the researcher's h-index. https://leetcode.com/problems/h-index/.
 * 
 ...
 * Example:
 * 
 * Input: citations = [3,0,6,1,5] Output: 3 Explanation: [3,0,6,1,5] means the researcher has 5
 ...
 * citations each, her h-index is 3. Note: If there are several possible values for h, the maximum
 ...
 * buckets, number from 0 to n, then for any paper with reference corresponding to the index of the
 * bucket, we increment the count for that bucket. The only exception is that for any paper with
 ...
 * we have 6 buckets to contain how many papers have the corresponding index. Hope to image and
 * explanation help.
 * 
 * 
 */
