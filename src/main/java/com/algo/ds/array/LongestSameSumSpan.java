...
/**
 * Give two arrays of same size consisting of 0s and 1s find span (i, j) such that sum of
 * input1[i..j] = sum of input2[i..j]
 *
 ...
 * Examples :
 * 
 * Input: arr1[] = {0, 1, 0, 0, 0, 0}; arr2[] = {1, 0, 1, 0, 0, 1}; Output: 4 The longest span with
 * same sum is from index 1 to 4.
 * 
 * Input: arr1[] = {0, 1, 0, 1, 1, 1, 1}; arr2[] = {1, 1, 1, 1, 1, 0, 1}; Output: 6 The longest span
 * with same sum is from index 1 to 6.
 * 
