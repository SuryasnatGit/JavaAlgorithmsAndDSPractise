 ...
 * 
 * Input: arr[] = [50, 40, 70, 60, 90] index[] = [3, 0, 4, 1, 2] Output: arr[] = [40, 60, 90, 50, 70] index[] = [0, 1,
 * 2, 3, 4]
 *
 * 
...
public class ReorderArrayByIndex {
	...
	/**
	 * Using auxillary array. Space - O(n) time - O(n)
	 * 
	 * @param input
	 * @param index
	 */
	public void rorder_simple(int[] input, int[] index) {
	...
	public static void main(String args[]) {
		...
		reorderArrayByIndex.rorder_simple(input, index);
	}
}
