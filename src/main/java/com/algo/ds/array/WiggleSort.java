 ...
 * 
 *         Time complexity O(n) - This depends on KthElementInArray time Space complexity O(1)
 *
 *         https://leetcode.com/problems/wiggle-sort/ https://leetcode.com/problems/wiggle-sort-ii/
 */
public class WiggleSort {

	// Sol 1 - looking for nums[0] < nums[1] > nums[2] < nums[3] and so on.
	...
	// Sol 2 - using modified bubble sort. in this version we are looking for nums[0] <= nums[1] >= nums[2] <= nums[3]
	// and so on.
