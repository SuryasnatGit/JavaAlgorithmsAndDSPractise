 ...
 * 
 * The reason this algorithm works is there can never be more than k-1 elements of size more than
 * n/k
 * 
 * This question does not make much sense. Why not just use a map and keep count and check if
 * occurrence is more than n/k. This is way too much effort to find elements more than n by k even
