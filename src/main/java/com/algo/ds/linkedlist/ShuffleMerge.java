 ...
 * 
 * Given two linklist shuffle merge them. e.g head1 = {1->3->5} head2 = {2->4} result =
 * {1->2->3->4->5} .
 * 
 * Test cases:<br/>
 * head1 is null and head2 is not <br/>
 * head2 is null and head1 is not <br/>
 * both are null <br/>
 * more nodes in head1 than head2 <br/>
