 ...
 *
 * References https://en.wikipedia.org/wiki/Dijkstra%27s_algorithm CLRS book
 */
...
//
//				// if heap does not contain adjacent vertex means adjacent vertex already has shortest distance from
//				// source vertex
...
//
//				// see if this above calculated distance is less than current distance stored for adjacent vertex from
//				// source vertex
