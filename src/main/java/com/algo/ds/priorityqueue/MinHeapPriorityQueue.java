...
public class MinHeapPriorityQueue<Key> implements Iterable<Key> {
	 ...
	 */
	public MinHeapPriorityQueue(int initCapacity) {
	 ...
	 *            the order in which to compare the keys
	 */
	public MinHeapPriorityQueue(Comparator<Key> comparator) {
		this(1, comparator);
	}
	 ...
	 *            the array of keys
	 */
	public MinHeapPriorityQueue(Key[] keys) {
		n = keys.length;
	...
	private class HeapIterator implements Iterator<Key> {
		...
		public HeapIterator() {
			if (comparator == null)
				copy = new MinHeapPriorityQueue<Key>(size());
			else
				copy = new MinHeapPriorityQueue<Key>(size(), comparator);
			for (int i = 1; i <= n; i++)
				copy.insert(pq[i]);
		}
	...
	public static void main(String[] args) {
		MinHeapPriorityQueue<String> pq = new MinHeapPriorityQueue<String>();
		// while (!StdIn.isEmpty()) {
