 ...
 * 
 * 
 * Assumption that both a and b are unique in tree. Test cases: Empty tree Tree with only root Tree
 * and input with a and b as cousin node Tree and input with a and b not cousin node Tree with input
 * a and b being siblings(not cousin)
 */
public class CousinNodes {

	/**
	 * Little more efficient than other method since this guy does not need another look up to see if
	 * parent is same for found nodes.
	 */
