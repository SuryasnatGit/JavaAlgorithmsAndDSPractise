 ...
 * 
 * Initially, all next pointers have NULL values. Your function should fill these next pointers so that they point to
 * inorder successor.
 * 
 * Time Complexity: O(n)
 */
public class PopulateInOrderSuccessor {
	...
	private void populate(TreeNode root, NodeRef nodeRef) {
		if (root == null) {
			return;
		}
	...
	/**
	 * Solution (Use Reverse Inorder Traversal) Traverse the given tree in reverse inorder traversal and keep track of
