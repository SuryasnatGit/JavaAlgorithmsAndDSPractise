 ...
 * 
 * Input: Two arrays that represent Inorder and level order traversals of a Binary Tree in[] = {4,
 * 8, 10, 12, 14, 20, 22}; level[] = {20, 8, 22, 4, 12, 10, 14};
 * 
 * Output: Construct the tree represented by the two arrays. For the above two arrays, the
 * constructed tree is shown in the diagram on right side
 * 
 ...
 * Test cases:
 * 
 * same length of inorder and level order array all elements should be same in them what to do if
 * repetition happens. This logic only works for non repeated values if inorder and levelorder were
 * represented by string how would you handle multi digits e.g 1234 we don't know if it is 12 34 or
 * 1 2 3 4 or what. Maybe use brackets (12)(3)(4) to differentiate between them.
 */
