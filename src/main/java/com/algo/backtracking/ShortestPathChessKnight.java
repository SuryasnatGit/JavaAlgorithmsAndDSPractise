...
public class ShortestPathChessKnight {
	...
	public static void main(String[] args) {
		...
		// source coordinates
		Node src = new ShortestPathChessKnight().new Node(0, 7);

		// destination coordinates
		Node dest = new ShortestPathChessKnight().new Node(7, 0);

		System.out.println(
				"Minimum number of steps required is " + new ShortestPathChessKnight().new Main().BFS(src, dest, N));
	}
}
