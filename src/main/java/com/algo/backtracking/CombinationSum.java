 ...
 * where the sum is equal to B. The same repeated number may be chosen from A
 * unlimited number of times.
 * 
 * Note:
 * 
 * All numbers will be positive integers. Elements in a combination (a1, a2, … ,
 * ak) must be in non-descending order. (ie, a1 ≤ a2 ≤ … ≤ ak). The combinations
 * themselves must be sorted in ascending order. If there is no combination
 * possible the print "Empty" (without qoutes).
 * 
